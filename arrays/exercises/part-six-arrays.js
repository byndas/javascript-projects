...
//3) Use bracket notation to examine the difference between 
//printing 'table' with one index vs. two indices (table[][]).
...
//Experiment! Create a 3-dimensional array and print out one entry from each array level.
let threeDArr = ["top array", ["middle array", ["bottom array"]]];
console.log(threeDArr[0], threeDArr[1][0], threeDArr[1][1][0]);