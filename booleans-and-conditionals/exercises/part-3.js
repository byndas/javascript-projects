...
if (fuelLevel < 1000 || engineTemperature > 3500 || engineIndicatorLight === "red blinking"){
    console.log("ENGINE FAILURE IMMINENT!"); // E
    ...
    console.log("Fuel and engine status pending..."); // F
  }
// 6) a) Create variable commandOverride, set it to true or false. 
// If commandOverride is false, then shuttle only launches if fuel and engine check are OK. 
//If commandOverride is true, then shuttle launches regardless of fuel and engine status.
...
if ((fuelLevel > 5000 && engineIndicatorLight !== "red blinking") || commandOverride){
